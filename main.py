...
# --- 1. ตั้งค่าหน้าแอป (ต้องอยู่บรรทัดแรก!) ---
...
def process_pdf(file_bytes):
    ...
    text = ""
    # อ่านแค่ 5 หน้าแรกพอเพื่อความรวดเร็วและไม่ให้ Token เกิน
    for page in doc[:5]: 
        text += page.get_text()
...
if 'user_results' not in st.session_state:
    st.session_state['user_results'] = {} # เก็บแคะแนนรายบท
...
if st.session_state['user_results']:
    ...
    with c2:
        ...
        # คำนวณคะแนนเฉลี่ยจากทุกบทที่ทำไป
